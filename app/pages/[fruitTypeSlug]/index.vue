...
const fruitTypeParam = isString(route.params?.fruitTypeSlug) ? route.params.fruitTypeSlug : 'apples';

const allFruitsResponse = await api.fetchFruitsByType(fruitTypeParam);
